...
class Language extends \App\Entity\Language implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Language' . "\0" . 'languageId', '' . "\0" . 'App\\Entity\\Language' . "\0" . 'name', '' . "\0" . 'App\\Entity\\Language' . "\0" . 'lastUpdate'];
        }
    ...
    public function isLanguageId(): ?bool
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'isLanguageId', []);

        return parent::isLanguageId();
    }
     ...
     * {@inheritDoc}
     */
    public function setLastUpdate(\DateTimeInterface $lastUpdate): \App\Entity\Language
    {
