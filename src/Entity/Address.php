...
class Address
{
     ...
     * @var string|null
     *
     * @ORM\Column(name="address2", type="string", length=50, nullable=true, options={"default"="NULL"})
     */
     ...
     * @var string|null
     *
     * @ORM\Column(name="postal_code", type="string", length=10, nullable=true, options={"default"="NULL"})
     */
