...
class Staff
{
     ...
     * @var string|null
     *
     * @ORM\Column(name="picture", type="blob", length=65535, nullable=true, options={"default"="NULL"})
     */
     ...
     * @var string|null
     *
     * @ORM\Column(name="password", type="string", length=40, nullable=true, options={"default"="NULL"})
     */
    ...
    public function isStaffId(): ?bool
    {
        return $this->staffId;
    }
